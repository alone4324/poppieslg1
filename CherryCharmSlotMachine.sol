...
/**
 * @title CherryCharmNFT
 * @dev NFT contract for CherryCharm slot machine rewards
 */
 ...
 * @dev Main slot machine contract with updated reward logic
 */
contract CherryCharmSlotMachine is Ownable {
    ...
    // Helper function for random generation in _generateNothing
